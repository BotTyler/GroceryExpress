...
public class WebObjectListAdapter extends BaseAdapter {

    Activity activity;
    List<WebObject> webObjectList;
    LayoutInflater inflater;

    public WebObjectListAdapter(Activity activity, List<WebObject> webObjectList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null){
            ...
            view = inflater.inflate(R.layout.web_object_layout, viewGroup, false);
